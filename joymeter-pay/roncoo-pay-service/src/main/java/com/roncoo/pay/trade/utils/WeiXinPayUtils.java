...
public class WeiXinPayUtils {
	...
	public static String getPrePayXml(WeiXinPrePay weiXinPrePay, String partnerKey) {
		...
		System.out.println(weiXinPrePay.getTradeType().name()+"getPrePayXml");
		System.out.println(WeiXinTradeTypeEnum.JSAPI.name()+"WeiXinTradeTypeEnum的JSAPI");
	    System.out.println(WeiXinTradeTypeEnum.NATIVE.name()+"WeiXinTradeTypeEnum的NATIVE");
		if (weiXinPrePay.getTradeType().name().equals("NATIVE")) {
			sb.append("<product_id>").append(weiXinPrePay.getProductId()).append("</product_id>");
		} else if (weiXinPrePay.getTradeType().name().equals("JSAPI")) {
			System.out.println(weiXinPrePay.getOpenid()+"getPrePayXml");
		...
		sb.append("</xml>");
        System.out.println(sb.toString()+"----------------------得到的xml");
		return sb.toString();
	}
