...
public interface RpTradePaymentManagerService {
     ...
     * @return
     */
	public F2FPayResultVo f2fPay(String openId, String payKey, String authCode, String productName, String orderNo,
			Date orderDate, Date orderTime, BigDecimal orderPrice, String payWayCode, String orderIp, String remark,
