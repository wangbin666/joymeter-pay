...
public class WeiXinPrePay implements Serializable {
	...
	public String toString() {
		return "WeiXinPrePay [appid=" + appid + ", mchId=" + mchId + ", deviceInfo=" + deviceInfo + ", nonceStr="
				+ nonceStr + ", sign=" + sign + ", body=" + body + ", detail=" + detail + ", attach=" + attach
				...
				+ ", notifyUrl=" + notifyUrl + ", tradeType=" + tradeType + ", tradeTypeCode=" + tradeTypeCode
				+ ", productId=" + productId + ", limitPay=" + limitPay + ", openid=" + openid + "]";
	}
