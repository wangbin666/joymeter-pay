...
import com.joymeter.common.util.MerchantApiUtil;
import com.joymeter.common.util.PayConfigUtil;
 ...
 */
@Controller
@RequestMapping(value = "/joymeterPay")
public class JoymeterPayController  extends BaseController{
        ...
        public String scanPay(HttpServletRequest httpServletRequest , HttpServletResponse httpServletResponse ,Model model){
            ...
            String orderPriceStr = getString_UrlDecode_UTF8("money"); // 订单金额 , 单位:元
            ...
            String payTypeCode = getString_UrlDecode_UTF8("payTypeCode");//支付类型编码： 如微信的公共号支付 jsapi
