...
public class Weixin {
    ...
    public static final String token = "";//微信公共号的token
    public static final String appId = "";   //appid需要去获取
    public static final String appSecret = "";//需要去微信获取
    public static final String apiKey = "";//需要去微信获取
    public static final String encodingAESKey="";//需要去微信获取
    public static final String toName = "";
    public static final String mchId="";//微信商户id
