...
//        btn14.setUrl("http://40ec4224.ngrok.io/wbweixin/index");
        btn14.setUrl("http://pay.qingcailuobo.cn/joymeter-pay-web-wechat/index");
        CommonButton btn21 = new CommonButton();
        btn21.setName("充值");
        btn21.setType("view");      
        //snsapi_base  snsapi_userinfo
        btn21.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa8c9e5fe21169ce9&redirect_uri=http://pay.qingcailuobo.cn/joymeter-pay-web-wechat/index&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect");
